...
namespace MyFirstCSharp
{
    public partial class Chap05_Operator : Form
    {
        ...
        private void btnEqual_Click(object sender, EventArgs e)
        {
            ...
            int iValue; // 첫번째 데이터 담는 변수
            iValue = 10; // = 을 통하여 10이라는 리터럴을 iValue 변수에 대입
        ...
        {
            // += 리터럴을 왼쪽 변수에 있는 값과 합한 후 결과를 다시 왼쪽 변수에 대입한다.
            int iValue = 10;
            iValue = iValue + 10;
        ...
        private void btnSS_Click(object sender, EventArgs e)
        {
            ...
            // 전위 증가 연산 : 코드가 실행될 때 자기 자신에게 1 증가 값이 대입

            // 전위 증가 연산(실시간 증가 연산 처리 기능) 사용하는 것을 권장
        }
